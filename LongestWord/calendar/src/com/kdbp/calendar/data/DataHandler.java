...
* DataHandler.java
*
* Created on November 24, 2001, 2:39 PM
**/
...
* It fulfills requests from the CalFrame.
* @author  Paul Miles
* @version 1.0
**/
public class DataHandler {
     ...
     **/
    public List getApptRange(GregorianCalendar firstDay, 
        ...
        LinkedList calDays = new LinkedList();
        ...
        for (int i = 0; i < appts.getLength(); i++) {
            ...
            Appt appt = new Appt( 
                        ...
                        Integer.parseInt((String)fields.get("duration")),
                        (String)fields.get("title"),
                        (String)fields.get("description"),
                        (String)fields.get("location"),
                        Integer.parseInt((String)fields.get("alarmTime")),
                        (String)fields.get("emailAddress"),
                        (String)fields.get("webAddress"));
            LinkedList recurDaysList = new LinkedList();
            StringTokenizer stk = 
     ...
     **/
    private static LinkedList getApptOccurences(Appt appt, 
    ...
    public boolean saveAppt(Appt appt) {
        ...
        Text durationText = doc.createTextNode(
        Integer.toString(appt.getDuration()));
        durationElement.appendChild(durationText);
        apptElement.appendChild(durationElement);
        ...
        Text locationText = doc.createTextNode(appt.getLocation());
        locationElement.appendChild(locationText);
        apptElement.appendChild(locationElement);
        
        Element alarmTimeElement = doc.createElement("alarmTime");
        Text alarmTimeText = doc.createTextNode(
        Integer.toString(appt.getAlarmTime()));
        alarmTimeElement.appendChild(alarmTimeText);
        apptElement.appendChild(alarmTimeElement);
        ...
        Element webAddressElement = doc.createElement("webAddress");
        Text webAddressText = doc.createTextNode(appt.getWebAddress());
        webAddressElement.appendChild(webAddressText);
        apptElement.appendChild(webAddressElement);
        ...
        appt.setXmlElement(apptElement);
